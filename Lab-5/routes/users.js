...
// Функція для перевірки, чи користувач аутентифікований
...
// Маршрути для обробки відновлення пароля
  ...
  async.waterfall(
    [
      ...
      (token, user) => {
        ...
        let mailOptions = {
          to: user.email,
          from: "Sobchenko Yaroslav yaroslav.game007@gmail.com",
